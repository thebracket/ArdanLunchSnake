...
experience. We havent' really talked much about *why* you might want to do this.
...
* Safety. You can make a real mess with mult-threaded Python. Rust lets you have some fearless concurrency.
* Speed.
